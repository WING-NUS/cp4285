    ...
    content:
      text: |
        <section class="page-changelog" aria-labelledby="home-changelog-title">
          ...
          <ul>
            <li><strong>8 Sep 2026</strong> — Made weekly schedule cards open and close from their non-interactive surface, while preserving links and embedded materials.</li>
